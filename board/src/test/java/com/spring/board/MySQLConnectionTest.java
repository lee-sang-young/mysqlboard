...
//    static final String URL = "jdbc:mysql://127.0.0.1:3306/board?serverTimezone=Asia/Seoul";
    static final String USERNAME = "page";
    static final String PASSWORD = "page1234";
